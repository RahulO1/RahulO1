...
> B.Tech in Computer Science & Engineering (2022–2026) • MERN Stack & Python Developer • Patent Holder • DSA Enthusiast
...
- **Book Store Management** — Full-stack bookstore with JWT auth, role-based access, and admin dashboard.  
  _Stack:_ MERN • JWT • Supabase • TailwindCSS  
  **Code:** https://github.com/RahulO1/Book_Store_Management_System

- **Online Food Delivery System** — Real-time food ordering system with payment simulation, ratings, and improved UI.  
  _Stack:_ Python • C/C++ • OOP • File handling  
  **Code:** https://github.com/RahulO1/Online_Food_Delivery_System-C-Python-

- **Titanic Survival Prediction** — ML model achieving 83.58% accuracy with Scikit-Learn, published in ASIANCON 2024.  
...
<!-- Optional Typing SVG -->
<!--
[![Typing SVG](https://readme-typing-svg.herokuapp.com?lines=Hi%2C+I'm+Pothu+Rahul;MERN+Stack+Developer;Python+Developer;Patent+Holder;Always+learning+%26+building)](https://git.io/typing-svg)
-->
```
